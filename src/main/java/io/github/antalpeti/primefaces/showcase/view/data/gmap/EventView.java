...
public class EventView implements Serializable {
  ...
  public void onStateChange(StateChangeEvent event) {
    ...
    addMessage(
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Zoom Level", String.valueOf(zoomLevel)));
    addMessage(
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Center", event.getCenter().toString()));
