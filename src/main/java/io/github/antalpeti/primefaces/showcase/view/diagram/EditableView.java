...
public class EditableView implements Serializable {
  ...
  public void init() {
    ...
    Element computerA =
        new Element(new NetworkElement("Computer A", "computer-icon.png"), "10em", "6em");
    ...
    Element computerB =
        new Element(new NetworkElement("Computer B", "computer-icon.png"), "25em", "6em");
    ...
    Element computerC =
        new Element(new NetworkElement("Computer C", "computer-icon.png"), "40em", "6em");
    ...
    Element serverA =
        new Element(new NetworkElement("Server A", "server-icon.png"), "15em", "24em");
    ...
    Element serverB =
        new Element(new NetworkElement("Server B", "server-icon.png"), "35em", "24em");
  ...
  public void onConnect(ConnectEvent event) {
    if (!suspendEvent) {
      FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Connected", "From "
          + event.getSourceElement().getData() + " To " + event.getTargetElement().getData());
